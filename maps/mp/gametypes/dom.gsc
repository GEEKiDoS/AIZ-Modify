...
InitWeapons()
{
	...
	level.sWeapons[level.sWeapons.size] = "pp2000_akimbo_mp";
	...
	level.sWeapons[level.sWeapons.size] = "deserteagle_akimbo_mp";
	...
	level.sWeapons[level.sWeapons.size] = "pp2000_akimbo_silencer_mp";
}
