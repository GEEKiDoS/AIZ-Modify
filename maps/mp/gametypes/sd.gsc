...
#include maps\mp\gametypes\doubleJump; 
...
onStartGameType()
{
	...
	if(getDvarInt("sv_doubleJumpMult") == 0)
		setDvar("sv_doubleJumpMult", 500);
		
	if(getDvarInt("sv_dashMult") == 0)
		setDvar("sv_dashMult", 500);
...
onPlayerConnect()
{
	for(;;)
	{
		...
		player thread watchMoveButtons();
	}
}
