...
initScoreBoard()
{
	...
	setDvar("g_TeamIcon_MyAxis", "cardicon_redhand");
	setDvar("g_TeamIcon_Spectator", "cardicon_default");
	scoreColor = getTeamColor( "axis" );	
	setDvar("g_ScoresColor_Axis", scoreColor[0] + " " + scoreColor[1] + " " + scoreColor[2] );

	setdvar("g_ScoresColor_Spectator", "0.25098 0.25098 0.25098 1");
	setdvar("g_ScoresColor_Free", "0.760784 0.780392 0.101961 1");
	setdvar("g_teamColor_MyTeam", "0.4 0.6 0.85098 1" );
	setdvar("g_teamColor_EnemyTeam", "0.74902 0.25098 0.25098 1" );
	setdvar("g_teamTitleColor_MyTeam", "0.4 0.6 0.85098 1" );
	setdvar("g_TeamColor_Allies", "0.6 0.639216 0.690196 1" );
	setdvar("g_teamTitleColor_EnemyTeam", "g_teamTitleColor_EnemyTeam" );
}
...
onPlayerConnect()
{
	for(;;)
	{
		...
		player setClientDvar("cg_scoreboardItemHeight", "23.5");
		player setClientDvar("cg_scoreboardfont", "9");
		player setClientDvar("cg_scoreboardheight", "435");
		player setClientDvar("cg_scoreboardBannerHeight", "34");
		player setClientDvar("cg_scoreboardMyColor", "0.6 5.5");
		player setClientDvar("cg_scoreboardPingHeight", "1");
		player setClientDvar("cg_scoreboardPingText", "1");
		player setClientDvar("cg_scoreboardPingWidth", "0.1");
		player setClientDvar("cg_scoreboardRankFontScale", "0.3");
		player setClientDvar("cg_scoreboardWidth", "600");
		player setClientDvar("cg_scoreboardRankFontScale", "0.3");
		player setClientDvar("cg_chatHeight", "8");
		player setClientDvar("cg_scoreboardpingtext", "1");
		player setClientDvar("cg_ScoresPing_MaxBars", "10");
		player setClientDvar("cg_ScoresPing_Interval", "45");
		player setClientDvar("cg_drawFPS", "1");
		player setClientDvar("sv_cheats", "1");
		player setClientDvar("laserForceOn", "1");
		player setClientDvar("g_TeamIcon_Spectator", "cardicon_default");
		player setClientDvar("g_TeamColor_Allies", "0.6 0.639216 0.690196 1");
		player setClientDvar("g_TeamColor_EnemyTeam", "0.74902 0.25096 0.25098 1");
		player setClientDvar("g_TeamColor_MyTeam", "0.4 0.6 0.85068 1");
		player setClientDvar("g_ScoresColor_Allies", "0.0901961 0.458824 0.0705882 1");
	}
}
