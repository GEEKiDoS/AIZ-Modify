...
RegisterAnimation(type)
{
	...
	switch(type)
	{
		...
		self.animationwalkspeed = 120;
		self.animationrun = "pb_pistol_run_fast";
		self.animationrunspeed = 160;
		self.animationsprint = "pb_sprint_gundown";
		self.animationsprintspeed = 220;
		...
		self.animationrunspeed = 150;
		self.animationsprint = "pb_sprint_akimbo";
		self.animationsprintspeed = 210;
		self.animationmelee = "pt_melee_pistol_1";
		self.animationmeleespeed = 0;
		break;
		case "normal_zombie_3":
...
play_CoolZombieDropIn(moveOrigin)
{
	moveOrigin = self.origin;
	self.origin = self.origin+(0,0,500);
	self moveTo(moveOrigin, 0.4);
	wait 0.4;
	playFx(loadfx("explosions/tanker_explosion"), self.origin);
