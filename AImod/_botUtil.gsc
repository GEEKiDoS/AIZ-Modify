...
SetMapSpawnPoint( )
{
    ...
    switch( getDvar("mapname") )
    {
        ...
        */
        ...
        case "mp_fuel2":
        {
            spawnpoint[spawnpoint.size] = (13102,29849,8033);
            spawnpoint[spawnpoint.size] = (12960,29570,8034);
            spawnpoint[spawnpoint.size] = (12704,28048,8465);
            spawnpoint[spawnpoint.size] = (14617,25078,9050);
            spawnpoint[spawnpoint.size] = (18060,32789,8633);
            spawnpoint[spawnpoint.size] = (22002,28482,6810);
            spawnpoint[spawnpoint.size] = (21824,28959,6834);
        }
        break;
        case "mp_overgrown":
        {
