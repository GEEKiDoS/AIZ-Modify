...
IntroInit()
{
	...
	text  = "Map: " + CustomMapnames();
	text2 = level.ObjectiveText;
	
	self thread WelcomeText("Welcome " + self.name, "AI Zombies eXtreme V2.1 Origins r2 Beta", text, "AIZE 2.1 by [Cirno]A2ON and CaptainLuis41. Based AIZE2.0 production.", text2, 1, (1,1,1), (0.3,0.9,0.3), 0.85, (1,1,1), (0.9,0.3,0.3), 0.85, (1,1,1), (1,0.5,0.3), 0.85, (1,1,1), (0.3,0.9,0.3), 0.85, (1,1,1), (0.3,0.9,0.9), 0.85);
}