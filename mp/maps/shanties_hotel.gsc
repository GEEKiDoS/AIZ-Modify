...
{
	level.botwaypoints = [];
	level.botwaypoints[level.botwaypoints.size] = CreateWayPoint(3309,-2336,651);
	level.botwaypoints[level.botwaypoints.size] = CreateWayPoint(3252,-2640,651);
	level.botwaypoints[level.botwaypoints.size] = CreateWayPoint(2829,-2343,651 );
	level.botwaypoints[level.botwaypoints.size] = CreateWayPoint(2539,-2330,651);
	level.botwaypoints[level.botwaypoints.size] = CreateWayPoint(2528,-1935,699);
	level.botwaypoints[level.botwaypoints.size] = CreateWayPoint(2949,-2003,651);
	level.botwaypoints[level.botwaypoints.size] = CreateWayPoint(3341,-2035,651);
}
...
SpawnObjects()
{
	Teleporter((3359,-2188,811),(0,0,0),(-1230,-1961,779));
	TeleporterBonus((3222,-2255,651),(0,0,0),(-1691,-1981,778));
	BonusDrop((-2142,-1996,757),(0,0,0),"Dual Wield AK-47's");
}